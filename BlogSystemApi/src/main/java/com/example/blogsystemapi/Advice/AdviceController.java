package com.example.blogsystemapi.Advice;
...
public class AdviceController {
    ...
    public ResponseEntity<ApiResponse> NullPointerException(MethodArgumentTypeMismatchException e) {
        String msg = e.getMessage();
        return ResponseEntity.status(400).body(new ApiResponse(msg));
    }

    @ExceptionHandler(value = ClassCastException.class)
    public ResponseEntity<ApiResponse> ClassCastException(MethodArgumentTypeMismatchException e) {
        String msg = e.getMessage();
        return ResponseEntity.status(400).body(new ApiResponse(msg));
    }
}
